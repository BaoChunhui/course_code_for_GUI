...
from vnpy.trader.object import TickData, ContractData, SubscribeRequest, OrderRequest, OrderData
...
class OrderMonitor2(BaseMonitor):
    """简化实现的委托监控控件"""
    headers: Dict[str, str] = {
        "代码": "symbol",
        "交易所": "exchange",
...
class MainWidget(QtWidgets.QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        # 监控表格
        self.order_monitor = OrderMonitor2(self.event_engine)
